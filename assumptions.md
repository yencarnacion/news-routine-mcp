...
- Per the explicit request to switch to Grok 4.6, the implementation defaults to `grok-4.6`, using the model ID and Responses API support documented at https://docs.x.ai/developers/grok-4-6.
