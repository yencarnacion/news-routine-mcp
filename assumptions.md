...
- I interpreted "Grok default to model 4.2" as a request for the latest xAI Grok model. The implementation now defaults to `grok-4.5`, which xAI documents as its latest model as of July 2026.
